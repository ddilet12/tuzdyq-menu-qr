...
export const categories: Record<string, Record<Lang, string>> = {
  ...
  cold_appetizers: { ru: "Холодные закуски", kz: "Салқын тағамдар", en: "Cold Appetizers" },
  ...
  kids_menu: { ru: "Детское меню", kz: "Балалар мәзірі", en: "Kids Menu" },
  sauce: { ru: "Соусы", kz: "Соустар", en: "Sauces" },
};
